...
col1.header("K/PP IDX:sunglasses:")
...
# fixer_res = prices(fixer_url, fixer_payload)
# phpkrw = fixer_res.json()["rates"]["KRW"]
...
# st.divider()
# st.dataframe(df2.style.hide_index(), use_container_width=True)
